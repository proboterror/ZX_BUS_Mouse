...
**Исправления:**
* Описание схемы в CPLD переписано на Verilog.
...
Текущая реализация использует 35 macrocells вместо 31. На EPM3032 доступно 32 macrocells, на EPM3064 64 macrocells.
