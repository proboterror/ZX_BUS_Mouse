...
## Известные проблемы:
На Scorpion ZS 256 в меню сервисного монитора мышь работает некорректно, при этом тест, загруженный в RAM, работает корректно. Симптоматически исправилось включением сигнала A15 в схему дешифрации, аргументированного объяснения этому пока нет. Вариант с использованием сигнала /DOS не проверялся.
